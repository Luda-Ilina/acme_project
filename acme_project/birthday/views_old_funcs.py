...
# Сначала создаем объект пагинатора и
# передаем в него список объектов, полученный из БД.
# Получим нужную страницу пагинатора: ожидаем, что в запросе будет параметр page=<номер_страницы> —
# вот по этому значению и запросим нужную страницу.
